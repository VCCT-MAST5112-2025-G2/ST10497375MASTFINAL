...
const styles = StyleSheet.create({
  ...
  courseOContainer: { flexDirection: "row", flexWrap: "wrap", marginBottom: 12 },
  courseButton: {
    paddingVertical: 6,
  ...
  menuList: { flex: 1 },
  menuItem: { padding: 10, borderBottomWidth: 1, borderBottomColor: "#eee" },
  menuName: { fontWeight: "600" },
  menuCourse: { color: "#555", marginTop: 4 },
});
